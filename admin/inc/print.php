<?php 
  ...
  class PDF extends FPDF
  {
    ...
    function Header(){
      ...
      $this->Cell(50,10,"Raise A Paw",0,1);
      $this->SetFont('Arial','',14);
      $this->Cell(50,7,"No.73,jawatta road,",0,1);
      $this->Cell(50,7,"colombo 00500.",0,1);
      $this->Cell(50,7,"TEL : 0123456789",0,1);
    ...
    function body($info,$products_info){
      ...
      foreach($products_info as $row){
        ...
        $this->Cell(70,9,$row["total"],"R",1,"R");
      }
      ...
      for($i=0;$i<12-count($products_info);$i++)
      {
        ...
        $this->Cell(70,9,"","R",1,"R");
      }
      //Display table total row
      $this->SetFont('Arial','B',12);
      $this->Cell(120,9,"TOTAL",1,0,"R");
      $this->Cell(70,9,$info["total_amt"],1,0,"R");
      ...
      $this->Cell(0,9,"BANK DETAILS ",0,1);
      $this->SetFont('Arial','',12);
      $this->Cell(0,6,$info["acc"],0,1);
      $this->Cell(0,6,$info["acc_name"],0,1);
      $this->Cell(0,6,$info["bank"],0,1);
      $this->Cell(0,6,$info["branch"],0,1);
