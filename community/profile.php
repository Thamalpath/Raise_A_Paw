...
<div class="row shadow-sm" id="profile-field">
	<div class="container">
		<div class="col-lg-12 mt-3 mb-3" style="height:60vh">
			<div class="position-relative image-fluid w-100 mb-1" style="height:400px;">
			...
			<div class="d-block w-100 py-2 px-1 text-center mt-3">
				<h2 class="text-dark text-center"><b style="font-family: 'Poppins';"><?php echo ucwords($_SESSION['login_firstname'] . ' ' . $_SESSION['login_lastname']); ?></b></h2>
				<a class="text-muted" style="font-size: 18px;"><?php echo $_SESSION['login_bio'] ?></a>
			</div>
		</div>
	</div>
</div>
<div class="container py-2 px-1 mt-3">
	<div class="col-lg-12">
		<div class="row">
			<div class="col-md-4">
				<div class="card about">
					<div class="card-header" style="background: #BD9292; color: #fff;">
						<h3 class="card-title" style="font-weight: 500; font-size: 20px; font-family: 'Poppins';">About Me</h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body">
						...
						<strong><i class="fa fa-id-card mr-1"></i> Role</strong>

						<p class="text-muted"><?php echo $_SESSION['login_role'] ?></p>
			...
			<div class="col-md-8">
				...
				$posts = $con->query("SELECT p.*,concat(u.firstname,' ',u.lastname) as name,u.profile_pic from posts p inner join users u on u.id = p.user_id  where p.user_id = {$_SESSION['login_id']} order by unix_timestamp(p.date_created) desc");
						...
						<div class="card card-widget post-card" data-id="<?php echo $row['id'] ?>">
							...
							<div class="card-footer">
								<form action="#" method="post">
									<i class="img-fluid img-circle img-sm fa fa-comment"  style="color: #71706E"></i>
