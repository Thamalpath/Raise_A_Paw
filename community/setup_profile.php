				...
				<div class="card-body">
					...
					<form action="" id="additional-info">
						...
						<div class="row">
							...
							<label for="" class="control-label mt-4">Profile Picture</label>
						...
						<div class="row">
							...
							<label for="" class="control-label">Cover Image</label>
								<div class="custom-file">
			                      <input type="file" class="custom-file-input" id="customFile" name="cover" accept="image/*" onchange="displayImgCover(this,$(this))" required>
			                      <label class="custom-file-label" for="customFile">Choose file</label>
			                    </div>
							</div>
						</div>
